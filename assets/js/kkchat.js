(function(cfg){
  ...
  const {
    ...
    meId: ME_ID = 0,
    meName: ME_NM = "",
    openDm: OPEN_DM_USER = null,
    isAdmin: IS_ADMIN = false,
    adminLinks: ADMIN_LINKS = [],
    genderIconBase: GENDER_ICON_BASE = "",
    pollSettings: POLL_SETTINGS_RAW = {},
  } = cfg;
  const POLL_SETTINGS = Object.freeze(POLL_SETTINGS_RAW || {});
...
(function(){
  ...
  function closeOverlay(){
    ...
    document.removeEventListener('click', trapFocus, true);
