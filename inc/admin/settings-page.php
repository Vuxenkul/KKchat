...
function kkchat_admin_settings_page() {
  ...
  <div class="wrap">
    ...
    <form method="post"><?php wp_nonce_field($nonce_key); ?>
      ...
      <p class="description">
        <?php esc_html_e('Konfigurera auto-IP-ban baserat på anmälningar. Ange 0 för att stänga av ett fält.', 'kkchat'); ?>
      </p>
      <table class="form-table">
        <tr>
          ...
          <td>
            ...
            <p class="description"><?php esc_html_e('Antal unika anmälare som krävs innan IP-adressen spärras automatiskt. Ange 0 för att stänga av.', 'kkchat'); ?></p>
          </td>
        </tr>
        <tr>
