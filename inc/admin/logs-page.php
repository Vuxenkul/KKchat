              ...
              <?php elseif ($convRows): ?>
                <?php foreach ($convRows as $r): ?>
                  ...
                  <div class="kkconv-msg">
                    ...
                    <?php if ($r->kind === 'image'): ?>
                      <div class="kkconv-meta">
                        <span class="kk-explicit-badge<?php echo !empty($r->is_explicit) ? '' : ' is-muted'; ?>"><?php echo !empty($r->is_explicit) ? 'XXX' : 'Inte XXX'; ?></span>
                      </div>
                    <?php endif; ?>
        ...
        <table class="widefat striped">
          ...
          <?php if ($rows): foreach ($rows as $m): ?>
            <tr>
              ...
              <td>
                <?php if ($m->kind === 'image'): ?>
                  <span class="kk-explicit-badge<?php echo !empty($m->is_explicit) ? '' : ' is-muted'; ?>"><?php echo !empty($m->is_explicit) ? 'XXX' : 'Inte XXX'; ?></span>
                <?php else: ?>
                  —
                <?php endif; ?>
              </td>
